...
extern struct Struct1940 *gUnknown_03000DA0[];

static inline void sub_0802C938_inline(struct Struct1940 **r6, s16 r5, int r7)
{
    u8 r1 = sub_08038DF4(255, 171, -1, (gUnknown_03000D78[r5].unk0 >> 8) + 12, gUnknown_030009E0 - 8, r7);
