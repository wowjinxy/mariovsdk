...
sub_0800F76C: @ 0x0800F76C
	...
	lsl r1, r1, #24
	lsr r4, r1, #24
	ldr r2, _0800F7D8  @ =gSaveFilesPtr
	ldr r0, _0800F7DC  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
sub_0800F84C: @ 0x0800F84C
	...
	lsl r0, r0, #24
	lsr r6, r0, #24
	ldr r1, _0800F9FC  @ =gSaveFilesPtr
	lsl r0, r6, #3
	sub r0, r0, r6
	lsl r0, r0, #5
	sub r0, r0, r6
...
sub_0800FA04: @ 0x0800FA04
	...
	lsl r2, r2, #24
	lsr r4, r2, #24
	ldr r2, _0800FA6C  @ =gSaveFilesPtr
	ldr r0, _0800FA70  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
_0800FB22:
	...
	THUMB_FUNC_START get_level_stats_0800FB28
get_level_stats_0800FB28: @ 0x0800FB28
	push {r4-r7,lr}
	lsl r0, r0, #24
	lsr r6, r0, #24
	lsl r1, r1, #24
	...
	lsl r2, r2, #24
	lsr r4, r2, #24
	ldr r2, _0800FB94  @ =gSaveFilesPtr
	ldr r0, _0800FB98  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
_0800FCDE:
	...
	pop {r1}
	bx r1
	THUMB_FUNC_END get_level_stats_0800FB28

	THUMB_FUNC_START get_level_stats_0800FCE4
get_level_stats_0800FCE4: @ 0x0800FCE4
	push {r4-r7,lr}
	lsl r0, r0, #24
	lsr r3, r0, #24
	add r7, r3, #0
	...
	lsl r2, r2, #24
	lsr r4, r2, #24
	ldr r2, _0800FD58  @ =gSaveFilesPtr
	ldr r0, _0800FD5C  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
_0800FE26:
	...
	pop {r1}
	bx r1
	THUMB_FUNC_END get_level_stats_0800FCE4

	THUMB_FUNC_START get_level_stats_0800FE2C
get_level_stats_0800FE2C: @ 0x0800FE2C
	push {r4-r7,lr}
	add r4, r3, #0
	lsl r0, r0, #24
	lsr r5, r0, #24
	...
	lsl r2, r2, #24
	lsr r6, r2, #24
	ldr r2, _0800FE9C  @ =gSaveFilesPtr
	ldr r0, _0800FEA0  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
_08010062:
	...
	pop {r1}
	bx r1
	THUMB_FUNC_END get_level_stats_0800FE2C

	THUMB_FUNC_START get_level_stats_08010068
get_level_stats_08010068: @ 0x08010068
	push {r4-r7,lr}
	ldr r6, [sp, #20]
	lsl r0, r0, #24
	lsr r0, r0, #24
	...
	lsl r3, r3, #24
	lsr r3, r3, #24
	ldr r2, _080100D8  @ =gSaveFilesPtr
	lsl r1, r0, #3
	sub r1, r1, r0
	lsl r1, r1, #5
	sub r1, r1, r0
...
_080102AE:
	...
	pop {r1}
	bx r1
	THUMB_FUNC_END get_level_stats_08010068
.endif
...
sub_080102B4: @ 0x080102B4
	...
	lsl r0, r0, #24
	lsr r5, r0, #24
	ldr r2, _08010328  @ =gSaveFilesPtr
	ldr r0, _0801032C  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
sub_08010534: @ 0x08010534
	...
	lsl r5, r1, #24
	lsr r6, r5, #24
	ldr r2, _0801056C  @ =gSaveFilesPtr
	ldr r0, _08010570  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
sub_080107E8: @ 0x080107E8
	...
	lsr r4, r2, #16
	mov r9, r4
	ldr r2, _08010830  @ =gSaveFilesPtr
	ldr r0, _08010834  @ =gSelectedSaveFileNumPtr
	ldr r0, [r0]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
sub_0801095C: @ 0x0801095C
	...
	lsr r4, r2, #24
	mov r8, r4
	ldr r3, _080109A8  @ =gSaveFilesPtr
	ldr r1, _080109AC  @ =gSelectedSaveFileNumPtr
	ldr r1, [r1]
	ldrb r2, [r1]
	lsl r1, r2, #3
	sub r1, r1, r2
...
sub_08010A3C: @ 0x08010A3C
	...
	mov r9, r0
	mov r8, r9
	ldr r1, _08010AD0  @ =gSaveFilesPtr
	ldr r2, _08010AD4  @ =gSelectedSaveFileNumPtr
	ldr r0, [r2]
	ldrb r3, [r0]
	lsl r0, r3, #3
	sub r0, r0, r3
...
_08010BA4:
	strb r0, [r4, #3]
_08010BA6:
	ldr r1, _08010BD8  @ =gSelectedSaveFileNumPtr
	ldr r0, [r1]
	ldrb r0, [r0]
	bl sub_0800F84C
	mov r0, #0
...
sub_08010BE0: @ 0x08010BE0
	...
	mov r10, r1
	mov r6, r10
	ldr r3, _08010C38  @ =gSaveFilesPtr
	ldr r2, _08010C3C  @ =gSelectedSaveFileNumPtr
	ldr r0, [r2]
	ldrb r1, [r0]
	lsl r0, r1, #3
	sub r0, r0, r1
...
_08010C48:
	...
	b _08010DB0
_08010C6A:
	ldr r1, _08010CDC  @ =gSelectedSaveFileNumPtr
	ldr r0, [r1]
	ldrb r0, [r0]
	mov r1, #1
	add r1, sp, r1
...
_08010DAE:
	strb r0, [r4, #3]
_08010DB0:
	ldr r1, _08010DE4  @ =gSelectedSaveFileNumPtr
	ldr r0, [r1]
	ldrb r0, [r0]
	bl sub_0800F84C
	mov r0, #0
...
sub_08010E90: @ 0x08010E90
	push {r4,r5,lr}
	ldr r0, _08010F5C  @ =gSaveFilesPtr
	ldr r0, [r0]
	mov r1, #223
	lsl r1, r1, #2
	add r4, r0, r1
...
sub_08010F60: @ 0x08010F60
	...
	push {r5-r7}
	sub sp, sp, #4
	ldr r2, _08011074  @ =gSaveFilesPtr
...
sub_08011098: @ 0x08011098
	...
	push {r5-r7}
	sub sp, sp, #4
	ldr r2, _08011184  @ =gSaveFilesPtr
...
sub_08011428: @ 0x08011428
	...
	mov r0, #0
	strh r0, [r1]
	ldr r0, _080114C0  @ =gSelectedSaveFileNumPtr
	ldr r1, [r0]
...
_08011452:
	...
	lsr r0, r0, #31
	bl sub_0807220C
	ldr r4, _080114C8  @ =gSaveFilesPtr
	ldr r0, [r4]
	bl sub_08010DEC
	ldr r0, [r4]
	mov r1, #223
