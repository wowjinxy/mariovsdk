...
sub_0801F554: @ 0x0801F554
	...
	mov r9, r6
	ldr r4, _0801F80C  @ =gfxBonusPresent4bpp
	str r4, [r6]
	ldrh r4, [r2]
	...
	str r4, [r6, #8]
	ldr r4, [r6, #8]
	ldr r5, _0801F818  @ =gfxBonusPresentOAM
	str r5, [r6]
	ldrh r4, [r0]
	lsl r4, r4, #3
	...
	ldr r5, [sp, #40]
	str r4, [r5]
	ldr r6, _0801F80C  @ =gfxBonusPresent4bpp
	mov r4, r9
	str r6, [r4]
	ldrh r4, [r2]
	ldr r5, _0801F810  @ =OBJ_VRAM0
...
sub_0801F838: @ 0x0801F838
	...
	ldr r0, _0801FB10  @ =gfxBonusPresent4bpp
	str r0, [r4]
	ldrh r0, [r6]
	...
	str r0, [r4, #8]
	ldr r0, [r4, #8]
	ldr r0, _0801FB1C  @ =gfxBonusPresentOAM
	str r0, [r4]
	ldrh r0, [r7]
	lsl r0, r0, #3
