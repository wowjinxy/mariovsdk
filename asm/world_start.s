...
world_start_init_callback: @ 0x08037050
	...
	bl sub_0807204C
_0803706C:
	ldr r4, _08037094  @ =gUnknown_030002FC
	mov r0, #16
	bl arena_allocate
	str r0, [r4]
...
_080370E8:
	...
	ldr r0, [r0]
	bl sub_08006968
	ldr r1, _08037124  @ =gUnknown_030002F0
	str r0, [r1]
...
_0803712C:
	...
	ldr r0, [r0]
	bl sub_08006968
	ldr r1, _080371BC  @ =gUnknown_030002F0
	str r0, [r1]
...
_08037166:
	...
	cmp r5, #0
	bne _080371D0
	ldr r1, _080371C8  @ =gUnknown_030002F4
	mov r0, #1
	strb r0, [r1]
	str r5, [sp]
	mov r4, #128
	...
	ldr r1, _080371CC  @ =gUnknown_03000300
	ldr r1, [r1]
	str r0, [r1, #16]
	ldr r1, [r1]
	bl sub_08040FC0
...
_080371C4:
	.4byte gUnknown_080A8674
_080371C8:
	.4byte gUnknown_030002F4
_080371CC:
	.4byte gUnknown_03000300
_080371D0:
	ldr r1, _08037218  @ =gUnknown_030002F4
	mov r0, #0
	strb r0, [r1]
	mov r0, #1
	mov r1, #0
...
_080371E6:
	...
	add r1, r4, #0
	bl CpuSet
	ldr r1, _08037228  @ =gUnknown_030002F8
...
sub_08037230: @ 0x08037230
	push {r4,r5,lr}
	ldr r4, _08037284  @ =gUnknown_03000300
	mov r0, #20
	bl arena_allocate
	str r0, [r4]
	mov r5, #0
	...
	lsl r1, r1, #2
	strh r1, [r0, #10]
	ldr r4, _08037290  @ =gUnknown_03000304
	mov r0, #20
	bl arena_allocate
	str r0, [r4]
	strh r5, [r0, #12]
...
sub_080372A0: @ 0x080372A0
	push {r4-r6,lr}
	sub sp, sp, #12
	ldr r6, _080372B8  @ =gUnknown_030002F4
	ldrb r0, [r6]
	cmp r0, #1
	beq _08037330
	cmp r0, #1
...
_080372C8:
	b _080374D0
_080372CA:  @ 0
	ldr r0, _080372EC  @ =gUnknown_030002FC
	ldr r4, [r0]
	ldrb r0, [r4, #1]
	sub r0, r0, #1
	strb r0, [r4, #1]
...
_080372F0:
	...
	mov r3, #64
	bl play_sound_effect_08071990
	ldr r1, _0803732C  @ =gUnknown_03000300
	ldr r1, [r1]
	str r0, [r1, #16]
	ldr r1, [r1]
	bl sub_08040FC0
...
_0803732C:
	.4byte gUnknown_03000300
_08037330: @ 1
	ldr r0, _08037354  @ =gUnknown_030002FC
	ldr r0, [r0]
	add r4, r0, #0
	add r4, r4, #8
	ldr r0, _08037358  @ =gUnknown_03000300
	ldr r2, [r0]
	ldr r3, [r2]
...
_08037360:
	...
	mov r3, #64
	bl play_sound_effect_08071990
	ldr r1, _080373EC  @ =gUnknown_03000304
	ldr r1, [r1]
	str r0, [r1, #16]
	ldr r1, [r1]
	bl sub_08040FC0
...
_080373CC:
	strb r0, [r4]
	ldr r0, _080373F0  @ =gUnknown_030002F0
	ldr r2, [r0]
	ldrb r0, [r4]
	ldrb r1, [r4, #4]
	add r0, r0, r1
...
_080373F4:
	...
	b _080374D0
_080373FA:  @ 2
	ldr r0, _08037418  @ =gUnknown_03000304
	ldr r2, [r0]
	ldr r3, [r2]
...
_08037420:
	...
	strh r0, [r2, #8]
	ldr r1, _08037458  @ =gUnknown_030002F8
...
_080374AC:
	.4byte gCurrentWorld
_080374B0:  @ 3
	ldr r2, _080374D8  @ =gUnknown_030002F8
	ldrh r0, [r2]
	add r0, r0, #128
	strh r0, [r2]
	lsl r0, r0, #16
...
world_start_main: @ 0x080374E0
	...
	bl sub_08029C20
	bl process_input
	ldr r0, _0803753C  @ =gUnknown_030002F4
	ldrb r0, [r0]
	cmp r0, #4
	bne _08037550
...
_08037548:
	...
	bl change_main_state
_08037550:
	ldr r0, _080375E0  @ =gUnknown_03000304
	ldr r3, [r0]
	mov r0, #8
	ldrsh r1, [r3, r0]
	lsl r0, r1, #1
...
_08037584:
	...
	strh r0, [r3, #14]
_08037596:
	ldr r0, _080375E8  @ =gUnknown_03000300
	ldr r3, [r0]
	mov r0, #8
	ldrsh r1, [r3, r0]
	lsl r0, r1, #1
...
sub_080375EC: @ 0x080375EC
	...
	mov r10, r3
	ldr r4, _0803764C  @ =gUnknown_030002F6
...
_0803769C:
	...
	ldr r0, [r5, #16]
	str r0, [r3]
	ldr r4, _0803782C  @ =gUnknown_030002F6
	ldrh r0, [r4]
	lsl r0, r0, #3
...
world_start_loop: @ 0x08037848
	...
	ldr r1, _080378BC  @ =gUnknown_030002F6
	mov r0, #0
	strh r0, [r1]
	strh r0, [r2]
	strh r0, [r3]
	ldr r0, _080378C0  @ =gUnknown_030002F4
	ldrb r0, [r0]
	cmp r0, #0
	beq _080378C8
	cmp r0, #1
	beq _08037930
	ldr r0, _080378C4  @ =gUnknown_03000304
	ldr r0, [r0]
	mov r1, #1
	b _08037964
_080378A0:
...
_080378C4:
	.4byte gUnknown_03000304
_080378C8:
	ldr r2, _08037924  @ =gUnknown_030002FC
	mov r8, r2
	ldr r3, [r2]
	ldrb r0, [r3, #2]
	ldrb r1, [r3, #3]
	ldr r7, _08037928  @ =gUnknown_030002F0
	mov r9, r7
	mov r2, r9
	ldr r4, [r2]
	ldrb r2, [r3]
...
_0803792C:
	.4byte gWorldOneStartData
_08037930:
	ldr r0, _08037998  @ =gUnknown_030002FC
	ldr r5, [r0]
	add r3, r5, #0
	add r3, r3, #8
	ldrb r0, [r3, #2]
	ldrb r1, [r3, #3]
	ldr r2, _0803799C  @ =gUnknown_030002F0
	ldr r4, [r2]
	ldrb r2, [r5, #8]
	ldrb r3, [r3, #4]
	add r2, r2, r3
	...
	str r4, [sp]
	bl sub_08006548
	ldr r0, _080379A4  @ =gUnknown_03000300
	ldr r0, [r0]
	mov r1, #0
_08037964:
	bl sub_080375EC
