...
_08035BAE:
	...
	add r0, r0, r1
	str r0, [r5]
	ldr r1, _08035CA4  @ =gObjVRAMCopyOffset_0300192C
	ldrh r0, [r1]
	...
	add r0, r0, #2
	strh r0, [r1]
	ldr r2, _08035CA4  @ =gObjVRAMCopyOffset_0300192C
	ldrh r0, [r2]
	add r0, r0, #64
	strh r0, [r2]
	ldrh r0, [r4]
...
_08035D0A:
	...
	add r0, r0, r1
	str r0, [r5]
	ldr r2, _08035E08  @ =gObjVRAMCopyOffset_0300192C
	ldrh r0, [r2]
	...
	add r0, r0, #2
	strh r0, [r7]
	ldr r1, _08035E08  @ =gObjVRAMCopyOffset_0300192C
	ldrh r0, [r1]
	add r0, r0, #64
	strh r0, [r1]
	ldrh r0, [r4]
...
sub_08035E2C: @ 0x08035E2C
	...
	add r1, r1, r4
	str r1, [r5]
	ldr r7, _08035F24  @ =gObjVRAMCopyOffset_0300192C
	ldrh r1, [r7]
...
sub_08035F4C: @ 0x08035F4C
	...
	ldr r4, [r0, #20]
	str r4, [r6]
	ldr r3, _0803605C  @ =gObjVRAMCopyOffset_0300192C
	ldrh r4, [r3]
	...
	ldrh r3, [r3]
	add r0, r0, r3
	ldr r4, _0803605C  @ =gObjVRAMCopyOffset_0300192C
	strh r0, [r4]
	mov r1, r9
	ldrh r0, [r1]
	add r0, r0, #1
...
sub_08036084: @ 0x08036084
	...
	add r1, r1, r4
	str r1, [r5]
	ldr r3, _080361A4  @ =gObjVRAMCopyOffset_0300192C
	ldrh r1, [r3]
	...
	ldrh r3, [r3]
	add r0, r0, r3
	ldr r4, _080361A4  @ =gObjVRAMCopyOffset_0300192C
	strh r0, [r4]
	mov r1, r9
	ldrh r0, [r1]
	add r0, r0, #1
...
_08036592:
	...
	add r0, r0, r1
	str r0, [r2]
	ldr r0, _0803669C  @ =gObjVRAMCopyOffset_0300192C
	mov r12, r0
	ldrh r0, [r0]
...
sub_08036D3C: @ 0x08036D3C
	...
	str r0, [r2]
	ldr r5, _08036EBC  @ =gObjVRAMCopyOffset_0300192C
	ldrh r0, [r5]
