...
_0802DED8:
	...
	strh r0, [r2]
	strh r4, [r7]
	ldr r1, _0802DF48  @ =gBGLayerOffset
...
_0802DFC2:
	...
	add r0, r4, #0
	strh r0, [r1]
	ldr r1, _0802E014  @ =gBGLayerOffset
	mov r0, #0
	strh r0, [r1]
	strh r0, [r1, #2]
	add r1, r3, #0
...
_0802E236:
	...
	mov r3, #64
	bl sub_08071990
	ldr r0, _0802E268  @ =gAfterTutorialLevel
	strb r4, [r0]
	mov r0, #12
	mov r1, #1
	bl sub_080070E8
...
_0802E67E:
	...
	mov r0, #3
	and r1, r1, r0
	ldr r3, _0802E6D8  @ =gBGLayerOffset
	neg r2, r7
	lsl r0, r2, #2
	add r0, r0, r2
	lsl r0, r0, #3
...
_0802EC9A:
	mov r0, #1
	strb r0, [r5]
	ldr r1, _0802ECC4  @ =gAfterTutorialWorld
	mov r0, #0
	strb r0, [r1]
	pop {r4,r5}
	pop {r0}
...
sub_0802ECC8: @ 0x0802ECC8
	...
	add r0, r0, #80
	strh r0, [r1]
	ldr r1, _0802ECEC  @ =gBGLayerOffset
	lsl r0, r0, #16
	lsr r0, r0, #24
	strh r0, [r1, #12]
	bl sub_0801B310
...
_0802F8CC:
	...
	cmp r0, #1
	bne _0802F91C
	ldr r1, _0802F918  @ =gBGLayerOffset
	mov r2, #0
	mov r0, #128
	lsl r0, r0, #1
	strh r0, [r1, #4]
...
_0802F918:
	.4byte gBGLayerOffset
_0802F91C:
	ldr r1, _0802F924  @ =gBGLayerOffset
	mov r0, #0
	strh r0, [r1, #4]
	b _0802F936
_0802F924:
...
_080321C8:
	...
	mov r0, sp
	strh r1, [r0]
	ldr r1, _08032204  @ =gBGLayerOffset
