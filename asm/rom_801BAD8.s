...
_0801BCB4:
	ldr r0, _0801BD3C  @ =gAfterTutorialLevel
	mov r6, #0
	ldrsb r6, [r0, r6]
...
pause_menu_init_callback: @ 0x0801BE34
	...
	ldr r0, _0801BE70  @ =gAfterTutorialLevel
	ldrb r0, [r0]
	strb r0, [r1]
...
_0801BEB4:
	...
	pop {r0}
	bx r0
	THUMB_FUNC_END pause_menu_main
...
sub_0801BED4: @ 0x0801BED4
	...
	ldr r0, _0801BF08  @ =gAfterTutorialLevel
	ldrb r0, [r0]
	strb r0, [r1]
...
sub_0801C1F0: @ 0x0801C1F0
	...
	mov r0, #0
	ldrsb r0, [r5, r0]
	ldr r1, _0801C26C  @ =gAfterTutorialWorld
	ldrb r1, [r1]
	lsl r1, r1, #24
	asr r1, r1, #24
	mov r2, #0
	...
	cmp r0, #0
	bne _0801C23C
	ldr r2, _0801C274  @ =gAfterTutorialLevel
	ldrb r1, [r2]
	mov r0, #2
	neg r0, r0
	and r0, r0, r1
...
_0801C378:
	bl sub_080720AC
	ldr r0, _0801C39C  @ =gAfterTutorialWorld
	strb r4, [r0]
	ldr r0, _0801C3A0  @ =gAfterTutorialLevel
	strb r4, [r0]
...
_08029682:
	...
	ldrb r0, [r0]
	ldr r1, _080296A0  @ =gAfterTutorialLevel
	ldrb r1, [r1]
	bl sub_08010BE0
_0802968E:
	mov r0, #1
...
_080298F2:
	...
	mov r1, #0
	bl sub_0800F6EC
	ldr r0, _08029930  @ =gAfterTutorialWorld
	strb r4, [r0]
	ldr r0, _08029934  @ =gAfterTutorialLevel
	strb r4, [r0]
	ldr r0, [r6]
	ldr r0, [r0, #4]
	bl sub_08004428
...
_08029982:
	...
	mov r1, #1
	bl sub_0800F6EC
	ldr r0, _080299C0  @ =gAfterTutorialWorld
	strb r5, [r0]
	ldr r0, _080299C4  @ =gAfterTutorialLevel
	strb r4, [r0]
	ldr r0, [r6]
	ldr r0, [r0, #4]
	bl sub_08004428
...
_080299C8:
	...
	mov r1, #1
	bl sub_080070E8
	ldr r0, _080299DC  @ =gAfterTutorialWorld
	strb r5, [r0]
	ldr r0, _080299E0  @ =gAfterTutorialLevel
	strb r5, [r0]
	b _08029A74
	.byte 0x00
	.byte 0x00
...
_08029B80:
	...
	THUMB_FUNC_START level_results_loop
level_results_loop: @ 0x08029B84
	push {r4-r7,lr}
	mov r7, r8
	push {r7}
	sub sp, sp, #12
...
_08029F1E:
	...
	.byte 0x00
	.byte 0x00
	THUMB_FUNC_START fade_transition_main
fade_transition_main: @ 0x08029F24
	push {lr}
...
_08029F78:
	.4byte 0x03000110
	THUMB_FUNC_END fade_transition_main
...
_0802AB2C:
	...
	ldr r0, _0802AB5C  @ =gAfterTutorialLevel
	ldrb r0, [r0]
	lsl r0, r0, #24
	asr r5, r0, #25
	ldr r6, _0802AB60  @ =gAfterTutorialWorld
	mov r1, #0
	ldrsb r1, [r6, r1]
	lsl r0, r1, #3
	sub r0, r0, r1
...
_0802B6AC:
	...
	ldr r0, _0802B704  @ =gAfterTutorialLevel
	ldrb r1, [r0]
	lsl r1, r1, #24
	asr r1, r1, #25
	ldr r0, _0802B708  @ =gAfterTutorialWorld
	mov r2, #0
	ldrsb r2, [r0, r2]
	lsl r0, r2, #3
	sub r0, r0, r2
...
_0802D204:
	...
	THUMB_FUNC_START movie_player_main
movie_player_main: @ 0x0802D208
	push {r4,lr}
...
_0802D384:
	.4byte gUnknown_030012E8
_0802D388:
	ldr r0, _0802D3B8  @ =gAfterTutorialWorld
	strb r1, [r0]
	mov r0, #128
	lsl r0, r0, #17
	mov r1, #1
...
_0802D3BC:
	.4byte 0x030001A0
_0802D3C0:
	ldr r0, _0802D3D4  @ =gAfterTutorialWorld
	strb r1, [r0]
	mov r0, #128
	lsl r0, r0, #17
	mov r1, #1
...
_0802D464:
	.4byte 0x030001A0
	THUMB_FUNC_END movie_player_main
...
_0802D50C:
	...
	THUMB_FUNC_START movie_player_init_callback
movie_player_init_callback: @ 0x0802D510
	push {r4,lr}
	mov r0, #0
	bl sub_08034898
...
_0802D584:
	.4byte 0x0000FF7F
	THUMB_FUNC_END movie_player_init_callback

	THUMB_FUNC_START movie_player_loop
movie_player_loop: @ 0x0802D588
	push {r4-r6,lr}
	sub sp, sp, #16
	add r0, sp, #8
	mov r4, #0
