...
_0800F708:
	...
	bne _0800F714
	add r0, r2, #0
	bl plus_world_level_setup
	b _0800F73E
_0800F714:
	cmp r0, #2
	bne _0800F720
	add r0, r2, #0
	bl expert_1_6_level_setup
	b _0800F73E
_0800F720:
	cmp r0, #3
	bne _0800F72C
	add r0, r2, #0
	bl expert_7_12_level_setup
	b _0800F73E
_0800F72C:
	cmp r0, #4
	bne _0800F738
	add r0, r2, #0
	bl dk_boss_level_setup
	b _0800F73E
_0800F738:
	add r0, r2, #0
	bl dk_boss_plus_level_setup
_0800F73E:
	pop {r0}
	bx r0
