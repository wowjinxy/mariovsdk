...
_0807167E:
	bl sub_08072230
	ldr r5, _08071790  @ =gUnknown_03001F10
	sub r1, r7, #1
	lsl r0, r1, #2
	add r0, r0, r1
	lsl r0, r0, #2
	...
	ldrb r1, [r1, #28]
	strb r1, [r0]
	ldr r0, _0807179C  @ =gUnknown_03001EE0
	ldr r6, [r5]
	mov r3, #181
	lsl r3, r3, #4
	add r2, r6, r3
	...
	ldr r3, _080717A4  @ =sub_0800023C
	str r3, [r1]
	str r2, [r1, #4]
	ldr r0, _080717A8  @ =0x80000074
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	ldr r4, _080717AC  @ =gUnknown_03001EF8
	ldr r0, _080717B0  @ =sound_related_08000260
	sub r0, r0, r3
	add r0, r2, r0
	str r0, [r4]
	ldr r4, _080717B4  @ =gUnknown_03001EE8
	ldr r0, _080717B8  @ =sub_080002A0
	sub r0, r0, r3
	add r2, r2, r0
	str r2, [r4]
...
_080717A8:
	.4byte 0x80000074
_080717AC:
	.4byte gUnknown_03001EF8
_080717B0:
	.4byte sound_related_08000260
_080717B4:
	.4byte gUnknown_03001EE8
_080717B8:
	.4byte sub_080002A0
_080717BC:
...
sub_08071800: @ 0x08071800
	...
	push {r5-r7}
	sub sp, sp, #8
	ldr r6, _08071928  @ =gUnknown_03001F10
	ldr r4, [r6]
	cmp r4, #0
	bne _08071816
	b _08071916
_08071816:
	...
	orr r0, r0, r2
	strb r0, [r4, #1]
	ldr r0, _08071930  @ =gUnknown_03001EE0
	ldr r2, [r0]
	mov r0, r8
	bl _call_via_r2
	ldr r2, [r6]
	...
	mov r4, #0
_0807187E:
	ldr r0, _08071928  @ =gUnknown_03001F10
	ldr r0, [r0]
...
_08071896:
	mov r4, #0
	ldr r1, _08071928  @ =gUnknown_03001F10
	ldr r0, [r1]
	add r3, r5, #1
	mov r9, r3
	ldrb r0, [r0]
...
_080718C8:
	...
	bcc _080718A8
_080718D6:
	ldr r0, _08071940  @ =gUnknown_03001EF8
	ldr r4, [r0]
	mov r0, r8
	mov r1, r10
	ldr r2, [sp]
	add r3, r7, #0
	bl _call_via_r4
	ldr r3, _08071928  @ =gUnknown_03001F10
	ldr r0, [r3]
	strb r5, [r0, #8]
	mov r5, r9
	cmp r5, #2
...
sub_0807194C: @ 0x0807194C
	push {lr}
	ldr r1, _08071970  @ =gUnknown_03001F10
	ldr r3, [r1]
	cmp r3, #0
	beq _0807198A
	ldrb r2, [r3, #1]
...
play_sound_effect_08071990: @ 0x08071990
	...
	mov r1, #0
	mov r9, r1
	ldr r2, _080719FC  @ =gUnknown_03001F10
	ldr r6, [r2]
	ldrb r3, [r6]
	mov r10, r3
	str r1, [sp, #12]
...
_08071AB2:
	...
	asr r0, r0, #14
	str r0, [r4, #12]
	ldr r5, _08071B00  @ =gUnknown_03001F10
	ldr r3, [r5]
	ldr r1, [r3, #12]
...
_08071B3A:
	...
	asr r0, r0, #14
	str r0, [r4, #12]
	ldr r2, _08071BA4  @ =gUnknown_03001F10
	ldr r3, [r2]
	ldr r1, [r3, #12]
...
sub_08071BCC: @ 0x08071BCC
	push {lr}
	ldr r0, _08071BDC  @ =gUnknown_03001EE8
	ldr r0, [r0]
	bl _call_via_r0
	pop {r0}
	bx r0
...
sub_08071BE0: @ 0x08071BE0
	...
	add r0, r0, #12
	str r1, [r0]
	ldr r0, _08071BFC  @ =gUnknown_03001F10
	ldr r2, [r0]
	ldrb r1, [r2, #1]
	mov r0, #4
	orr r0, r0, r1
...
sub_08071C00: @ 0x08071C00
	ldr r0, _08071C18  @ =gUnknown_03001F10
	ldr r2, [r0]
	ldrb r1, [r2, #1]
	mov r0, #251
	and r0, r0, r1
...
sub_08071C24: @ 0x08071C24
	push {r4-r6,lr}
	mov r4, #0
	ldr r1, _08071C60  @ =gUnknown_03001F10
	ldr r0, [r1]
	ldrb r0, [r0]
	cmp r4, r0
	bge _08071C5A
...
sub_08071C6C: @ 0x08071C6C
	...
	add r7, r1, r0
	mov r5, #0
	ldr r1, _08071CC4  @ =gUnknown_03001F10
	ldr r0, [r1]
	ldrb r0, [r0]
	cmp r5, r0
	bge _08071CB8
...
sub_08071CD4: @ 0x08071CD4
	push {r4-r6,lr}
	mov r4, #0
	ldr r1, _08071D1C  @ =gUnknown_03001F10
	ldr r0, [r1]
	ldrb r0, [r0]
	cmp r4, r0
	bge _08071D14
...
sub_08071D28: @ 0x08071D28
	...
	mov r12, r1
	add r7, r2, #0
	ldr r1, _08071D6C  @ =gUnknown_03001F10
	ldr r0, [r1]
	ldrb r4, [r0]
...
sub_08071D9C: @ 0x08071D9C
	push {r4-r7,lr}
	add r5, r0, #0
	ldr r1, _08071E04  @ =gUnknown_03001F10
	ldr r0, [r1]
	ldrb r4, [r0]
...
sub_08071E14: @ 0x08071E14
	...
	add r1, r1, r0
	mov r8, r1
	ldr r0, _08071E70  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sub_08071E7C: @ 0x08071E7C
	...
	lsl r1, r1, #24
	mov r7, #1
	ldr r2, _08071ED8  @ =gUnknown_03001F10
	ldr r2, [r2]
...
_08071EA2:
	...
	mov r0, #0
	strb r0, [r4]
	ldr r0, _08071ED8  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sound_finish: @ 0x08071EE4
	...
	str r4, [r0]
	bl sub_0807229C
	ldr r0, _08071F0C  @ =gUnknown_03001F10
	str r4, [r0]
	pop {r4}
	pop {r0}
	bx r0
...
sub_08071F10: @ 0x08071F10
	push {lr}
	add r1, r0, #0
	ldr r0, _08071F24  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sub_08071F2C: @ 0x08071F2C
	push {lr}
	add r1, r0, #0
	ldr r0, _08071F40  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sub_08071F48: @ 0x08071F48
	push {lr}
	ldr r0, _08071F5C  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sub_08071FA0: @ 0x08071FA0
	...
	mov r9, r2
	mov r10, r3
	ldr r5, _08071FDC  @ =gUnknown_03001F10
	ldr r0, [r5]
...
_08071FF8:
	...
	cmp r2, r1
	bge _0807201E
	ldr r0, _0807202C  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sub_08072038: @ 0x08072038
	ldr r0, _08072044  @ =gUnknown_03001F10
	ldr r0, [r0]
...
play_bgm: @ 0x0807204C
	...
	add r7, r1, #0
	mov r10, r2
	ldr r0, _080720A0  @ =gUnknown_03001F10
	mov r9, r0
	ldr r0, [r0]
...
sub_080720AC: @ 0x080720AC
	push {r4,r5,lr}
	ldr r4, _080720D8  @ =gUnknown_03001F10
	ldr r1, [r4]
...
sub_080720E4: @ 0x080720E4
	push {r4,lr}
	ldr r0, _0807210C  @ =gUnknown_03001F10
	ldr r2, [r0]
...
sub_08072118: @ 0x08072118
	push {lr}
	ldr r0, _0807213C  @ =gUnknown_03001F10
	ldr r2, [r0]
...
sub_08072144: @ 0x08072144
	push {lr}
	mov r2, #0
	ldr r0, _08072164  @ =gUnknown_03001F10
	ldr r0, [r0]
...
sub_0807216C: @ 0x0807216C
	push {r4,r5,lr}
	ldr r0, _080721A0  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0]
	mov r4, #0
...
sub_080721A8: @ 0x080721A8
	push {r4-r6,lr}
	add r5, r0, #0
	ldr r0, _080721D4  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r4, [r0]
...
sub_080721F8: @ 0x080721F8
	ldr r0, _08072208  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
sub_0807220C: @ 0x0807220C
	push {r4,lr}
	ldr r4, _0807222C  @ =gUnknown_03001F10
	ldr r3, [r4]
	ldrb r2, [r3, #1]
	mov r1, #239
	and r1, r1, r2
...
sub_080728F0: @ 0x080728F0
	...
	mov r7, #0
	ldrsb r7, [r6, r7]
	ldr r0, _08072944  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072954:
	...
	add r7, r5, #0
	add r7, r7, #45
	ldr r0, _080729F0  @ =gUnknown_03001F10
	mov r9, r0
...
_08072A34:
	...
	mov r7, #0
	ldrsb r7, [r5, r7]
	ldr r0, _08072A78  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072ABA:
	...
	mov r7, #0
	ldrsb r7, [r5, r7]
	ldr r0, _08072B00  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072B58:
	...
	mov r7, #0
	ldrsb r7, [r6, r7]
	ldr r0, _08072B98  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072C10:
	...
	mov r6, #0
	ldrsb r6, [r5, r6]
	ldr r0, _08072C64  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072CFC:
	...
	mov r6, #0
	ldrsb r6, [r5, r6]
	ldr r0, _08072D44  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072E0C:
	...
	mov r6, #0
	ldrsb r6, [r5, r6]
	ldr r0, _08072E54  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072EC8:
	...
	mov r6, #0
	ldrsb r6, [r5, r6]
	ldr r0, _08072F1C  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08072F78:
	...
	mov r7, #0
	ldrsb r7, [r5, r7]
	ldr r0, _08072FB8  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08073038:
	...
	mov r7, #0
	ldrsb r7, [r5, r7]
	ldr r0, _08073088  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_0807311A:
	...
	mov r7, #0
	ldrsb r7, [r5, r7]
	ldr r0, _08073164  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
sub_0807394C: @ 0x0807394C
	...
	ldrsb r0, [r5, r0]
	mov r8, r0
	ldr r0, _080739A0  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_080739DA:
	...
	mov r7, #0
	ldrsb r7, [r6, r7]
	ldr r0, _08073A24  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08073A58:
	...
	mov r6, #0
	ldrsb r6, [r5, r6]
	ldr r0, _08073A9C  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
...
_08073ABC:
	...
	mov r7, #0
	ldrsb r7, [r5, r7]
	ldr r0, _08073B08  @ =gUnknown_03001F10
	ldr r0, [r0]
	ldrb r1, [r0, #1]
	mov r0, #16
	and r0, r0, r1
