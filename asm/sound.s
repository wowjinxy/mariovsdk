...
_0807167E:
	...
	ldrb r1, [r1, #28]
	strb r1, [r0]
	ldr r0, _0807179C  @ =ptr_arm_clear_audio_buffer
	ldr r6, [r5]
	mov r3, #181
	lsl r3, r3, #4
	add r2, r6, r3
	...
	ldr r3, _080717A4  @ =arm_clear_audio_buffer
	str r3, [r1]
	str r2, [r1, #4]
	ldr r0, _080717A8  @ =0x80000074
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	ldr r4, _080717AC  @ =ptr_arm_load_sound_16bit_to_8bit
	ldr r0, _080717B0  @ =arm_load_sound_16bit_to_8bit
	sub r0, r0, r3
	add r0, r2, r0
	str r0, [r4]
	ldr r4, _080717B4  @ =ptr_arm_set_sound_dma_regs
	ldr r0, _080717B8  @ =arm_set_sound_dma_regs
	sub r0, r0, r3
	add r2, r2, r0
	str r2, [r4]
	ldr r0, _080717BC  @ =gUnknown_03001EE4
	ldr r3, _080717C0  @ =0x00000C38
	add r2, r6, r3
	str r2, [r0]
	ldr r3, _080717C4  @ =sub_08001760_end
	str r3, [r1]
	str r2, [r1, #4]
	ldr r0, _080717C8  @ =0x800001C8
	str r0, [r1, #8]
	ldr r0, [r1, #8]
	ldr r1, _080717CC  @ =gUnknown_03001EFC
	ldr r0, _080717D0  @ =sub_08001968
	sub r0, r0, r3
	add r2, r2, r0
	str r2, [r1]
	strb r7, [r6]
	...
	add r0, r2, #0
	strh r0, [r1]
	add r1, r1, #62    @ REG_OFFSET_DMA1DAD
...
_08071798:
	.4byte 0x000014C3
_0807179C:
	.4byte ptr_arm_clear_audio_buffer
_080717A0:
	.4byte REG_DMA3SAD
_080717A4:
	.4byte arm_clear_audio_buffer
_080717A8:
	.4byte 0x80000074
_080717AC:
	.4byte ptr_arm_load_sound_16bit_to_8bit
_080717B0:
	.4byte arm_load_sound_16bit_to_8bit
_080717B4:
	.4byte ptr_arm_set_sound_dma_regs
_080717B8:
	.4byte arm_set_sound_dma_regs
_080717BC:
	.4byte gUnknown_03001EE4
_080717C0:
	.4byte 0x00000C38
_080717C4:
	.4byte sub_08001760_end
_080717C8:
	.4byte 0x800001C8
_080717CC:
	.4byte gUnknown_03001EFC
_080717D0:
	.4byte sub_08001968
_080717D4:
...
_08071816:
	...
	add r3, r3, r1
	str r3, [sp]
	ldr r0, _0807192C  @ =gUnknown_03001F00
	ldr r0, [r0]
	str r0, [sp, #4]
	add r7, r1, #0
	mov r0, #8
	orr r0, r0, r2
	strb r0, [r4, #1]
	ldr r0, _08071930  @ =ptr_arm_clear_audio_buffer
	ldr r2, [r0]
	mov r0, r8
	bl _call_via_r2
	ldr r2, [r6]
...
_080718C8:
	...
	bcc _080718A8
_080718D6:
	ldr r0, _08071940  @ =ptr_arm_load_sound_16bit_to_8bit
	ldr r4, [r0]
	mov r0, r8
	mov r1, r10
	ldr r2, [sp]
...
_080718F4:
	ldr r0, [r3]
	strb r5, [r0, #5]
	ldr r2, _08071944  @ =gUnknown_03001F04
	ldr r0, _0807192C  @ =gUnknown_03001F00
	ldr r1, [r0]
	ldr r0, [sp, #4]
	sub r1, r1, r0
	str r1, [r2]
	ldr r2, _08071948  @ =gUnknown_03001F08
	ldr r0, [r2]
	add r0, r0, r1
	str r0, [r2]
	ldr r2, [r3]
...
play_sound_effect_08071990: @ 0x08071990
	...
	sub r1, r1, r0
	lsl r1, r1, #2
	ldr r0, _08071A00  @ =gSoundEffectTable
	add r1, r1, r0
	mov r12, r1
	cmp r5, #15
	bls _080719D8
...
sub_08071BCC: @ 0x08071BCC
	push {lr}
	ldr r0, _08071BDC  @ =ptr_arm_set_sound_dma_regs
	ldr r0, [r0]
	bl _call_via_r0
	pop {r0}
	bx r0
...
sub_08071C6C: @ 0x08071C6C
	...
	sub r1, r1, r0
	lsl r1, r1, #2
	ldr r0, _08071CC0  @ =gSoundEffectTable
	add r7, r1, r0
	mov r5, #0
	ldr r1, _08071CC4  @ =gSoundWork
	ldr r0, [r1]
	ldrb r0, [r0]
	cmp r5, r0
	bge _08071CB8
...
sub_08071E14: @ 0x08071E14
	...
	sub r1, r1, r0
	lsl r1, r1, #2
	ldr r0, _08071E6C  @ =gSoundEffectTable
	add r1, r1, r0
	mov r8, r1
	ldr r0, _08071E70  @ =gSoundWork
	ldr r0, [r0]
...
_08071EE0:
	...
	THUMB_FUNC_START sound_finish
sound_finish: @ 0x08071EE4
	push {r4,lr}
...
_08071F0C:
	.4byte gSoundWork
	THUMB_FUNC_END sound_finish

	THUMB_FUNC_START sub_08071F10
sub_08071F10: @ 0x08071F10
	push {lr}
	add r1, r0, #0
	ldr r0, _08071F24  @ =gSoundWork
	ldr r0, [r0]
...
_08071F60:
	...
	THUMB_FUNC_START get_song_volume
get_song_volume: @ 0x08071F64
	ldr r2, _08071F74  @ =gMusicTable
	lsl r1, r0, #1
	add r1, r1, r0
	lsl r1, r1, #2
	add r1, r1, r2
...
_08071F74:
	.4byte gMusicTable
	THUMB_FUNC_END get_song_volume

	THUMB_FUNC_START get_song_data
get_song_data: @ 0x08071F78
	ldr r2, _08071F88  @ =gMusicTable
	lsl r1, r0, #1
	add r1, r1, r0
	lsl r1, r1, #2
	add r1, r1, r2
...
sub_08071F8C: @ 0x08071F8C
	...
	add r0, r0, r1
	lsl r0, r0, #2
	ldr r1, _08071F9C  @ =gMusicTable+6
	add r0, r0, r1
	bx lr
	.byte 0x00
	.byte 0x00
...
_08071FE0:
	...
	THUMB_FUNC_START get_current_bgm
get_current_bgm: @ 0x08071FE4
	push {r4,lr}
	bl sub_08072144
	cmp r0, #0
	beq _08071FF8
...
_08071FF8:
	...
	cmp r2, r1
	bge _0807201E
	ldr r0, _0807202C  @ =gSoundWork
	ldr r0, [r0]
	ldr r3, _08072030  @ =0x00000FC8
	add r0, r0, r3
	ldr r4, [r0]
	add r3, r1, #0
	ldr r1, _08072034  @ =gMusicTable
_08072010:
	ldr r0, [r1]
	cmp r4, r0
	beq _08071FF4
...
_08072034:
	.4byte gMusicTable
	THUMB_FUNC_END get_current_bgm

	THUMB_FUNC_START sub_08072038
sub_08072038: @ 0x08072038
	ldr r0, _08072044  @ =gSoundWork
	ldr r0, [r0]
...
play_bgm: @ 0x0807204C
	...
	add r7, r1, #0
	mov r10, r2
	ldr r0, _080720A0  @ =gSoundWork
	mov r9, r0
	ldr r0, [r0]
	ldr r1, _080720A4  @ =0x00000FC8
	mov r8, r1
	add r0, r0, r8
	ldr r5, _080720A8  @ =gMusicTable
	lsl r4, r3, #1
	add r4, r4, r3
	lsl r4, r4, #2
	add r6, r4, r5
...
sub_080728F0: @ 0x080728F0
	...
	strb r0, [r6]
_08072922:
	ldr r0, _08072948  @ =gUnknown_03001F28
	str r5, [r0]
	ldr r4, _0807294C  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072950  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072934
	mov r3, #1
...
_08072944:
	.4byte gSoundWork
_08072948:
	.4byte gUnknown_03001F28
_0807294C:
	.4byte gUnknown_03001EFC
_08072950:
	.4byte gUnknown_03000820
_08072954:
	ldr r0, _080729EC  @ =gUnknown_03000824
	ldr r3, [r0]
	add r7, r5, #0
	add r7, r7, #45
	ldr r0, _080729F0  @ =gSoundWork
	mov r9, r0
	ldr r1, _080729F4  @ =gUnknown_03001F28
	mov r10, r1
...
_080729BC:
	...
	str r5, [r2]
	mov r3, #0
	ldr r1, _080729FC  @ =gUnknown_03000820
	ldr r0, [r1]
	cmp r0, #0
	bne _080729CC
	mov r3, #1
_080729CC:
	ldr r2, _08072A00  @ =gUnknown_03001EFC
	ldr r4, [r2]
	add r0, r5, #0
	mov r1, r12
	mov r2, r8
...
sub_08072A04: @ 0x08072A04
	...
	ldrb r1, [r0]
_08072A14:
	ldr r0, _08072A74  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, #0
	beq _08072A34
	lsl r1, r1, #2
...
_08072A34:
	...
	strb r0, [r5]
_08072A4E:
	ldr r0, _08072A7C  @ =gUnknown_03001F28
	str r3, [r0]
	ldr r4, _08072A80  @ =gUnknown_03001EFC
	mov r6, #0
	ldr r0, _08072A84  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072A60
	mov r6, #1
...
sub_08072A88: @ 0x08072A88
	...
	ldrb r1, [r0]
_08072A98:
	ldr r0, _08072AFC  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, #0
	beq _08072ABA
	lsl r0, r1, #2
...
_08072ABA:
	...
	strb r0, [r5]
_08072AD4:
	ldr r0, _08072B04  @ =gUnknown_03001F28
	str r3, [r0]
	ldr r4, _08072B08  @ =gUnknown_03001EFC
	mov r6, #0
	ldr r0, _08072B0C  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072AE6
	mov r6, #1
...
_08072B2A:
	lsl r4, r4, #2
	ldr r0, _08072B44  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, #0
	beq _08072B58
	cmp r3, #0
...
_08072B58:
	...
	strb r0, [r6]
_08072B72:
	ldr r0, _08072B9C  @ =gUnknown_03001F28
	str r5, [r0]
	ldr r4, _08072BA0  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072BA4  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072B84
	mov r3, #1
...
_08072BD4:
	...
	add r1, r3, #0
	and r1, r1, r0
	lsl r1, r1, #1  @ (r3 & 0xF) << 1
	asr r3, r3, #4
	and r3, r3, r0  @ (r3 >> 4) & 0xF
	lsl r0, r4, #2
	add r0, r0, r5
	ldr r0, [r0]
	mul r0, r1, r0
...
_08072C10:
	...
	strb r0, [r5]
_08072C36:
	ldr r0, _08072C68  @ =gUnknown_03001F28
	mov r1, r12
	str r1, [r0]
	ldr r4, _08072C6C  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072C70  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072C4A
	mov r3, #1
...
_08072CA2:
	add r2, r0, #0
	lsl r4, r4, #2
	ldr r0, _08072CC0  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, #0
	beq _08072CFC
	cmp r3, #0
...
_08072CFC:
	...
	strb r0, [r5]
_08072D16:
	ldr r0, _08072D48  @ =gUnknown_03001F28
	mov r1, r12
	str r1, [r0]
	ldr r4, _08072D4C  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072D50  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072D2A
	mov r3, #1
...
_08072DCE:
	...
	add r0, r0, #72
	strh r3, [r0]
	ldr r0, _08072DF8  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, #0
	beq _08072E0C
	mov r1, r12
...
_08072E0C:
	...
	strb r0, [r5]
_08072E26:
	ldr r0, _08072E58  @ =gUnknown_03001F28
	mov r1, r12
	str r1, [r0]
	ldr r4, _08072E5C  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072E60  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072E3A
	mov r3, #1
...
_08072EC8:
	...
	strb r0, [r5]
_08072EEE:
	ldr r0, _08072F20  @ =gUnknown_03001F28
	mov r1, r12
	str r1, [r0]
	ldr r4, _08072F24  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072F28  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072F02
	mov r3, #1
...
_08072F40:
	...
	neg r3, r1
_08072F46:
	ldr r0, _08072F64  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, #0
	beq _08072F78
	add r1, r6, #0
...
_08072F78:
	...
	strb r0, [r5]
_08072F92:
	ldr r0, _08072FBC  @ =gUnknown_03001F28
	str r6, [r0]
	ldr r4, _08072FC0  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08072FC4  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08072FA4
	mov r3, #1
...
sub_08072FC8: @ 0x08072FC8
	...
	ldrb r0, [r0]
	str r0, [sp, #8]
	ldr r0, _08073080  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	beq _08073094
	mov r2, #0
...
_08072FFE:
	...
	cmp r7, #38
	bne _08073038
	ldr r0, _08073084  @ =gUnknown_03000824
	ldr r0, [r0]
	ldrb r1, [r6, #26]
	cmp r0, r1
	bcc _08073072
_08073038:
	...
	strb r0, [r5]
_08073052:
	ldr r0, _0807308C  @ =gUnknown_03001F28
	str r6, [r0]
	ldr r4, _08073090  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08073080  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
...
_0807311A:
	...
	strb r0, [r5]
_0807313C:
	ldr r0, _08073168  @ =gUnknown_03001F28
	str r6, [r0]
	ldr r4, _0807316C  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08073170  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _0807314E
	mov r3, #1
...
_08073514:
	...
	add r3, r5, #0
	mul r3, r0, r3
	add r3, r3, r6  @ arg0 + i*76
	add r3, r3, #4
	lsl r1, r5, #1
	ldr r0, [r6]
	add r1, r1, r0  @ arg0->unk0 + i*2
	mov r7, #145
	lsl r7, r7, #2  @ 0x244
	add r1, r1, r7  @ arg0->unk0 + 0x244 + i*2
	add r4, r3, #0  @ arg0 + 4 + i*76
	mov r2, #0
_0807352E:
	add r0, r4, r2
	mov r7, r12
...
_0807373C:
	...
	lsl r5, r5, #2  @ 0x284
	add r0, r0, r5
	add r0, r3, r0  @ data + 0x284 + data->unk44[arg0->unk4F0]*8
	add r1, r1, #6  @ 0x4F6
	add r2, r4, r1
	mov r5, #0
...
_08073786:
	...
	ldrh r1, [r3, #52]
	cmp r0, r1
	blt _0807377C  @ loop back (condition check)
	...
	and r0, r0, r1
	cmp r0, #0
	bne _080736C8  @ jump up
	ldr r0, _0807383C  @ =0x0000FFFE
_080737AC:  @ come from above
	strh r0, [r2]
_080737AE:
	mov r2, #157
	lsl r2, r2, #3  @ 0x4E8
...
_080737CA:
	...
	mov r9, r1
_080737DC:
	ldr r0, _08073844  @ =gUnknown_03000824
	str r7, [r0]
	ldr r0, _08073848  @ =gUnknown_03000820
	str r6, [r0]
	add r0, r4, #0
	mov r1, r10
	mov r2, r9
...
sub_0807394C: @ 0x0807394C
	...
	strb r0, [r5]
_08073972:
	ldr r0, _080739A4  @ =gUnknown_03001F28
	str r3, [r0]
	ldr r4, _080739A8  @ =gUnknown_03001EFC
	mov r6, #0
	ldr r0, _080739AC  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08073984
	mov r6, #1
...
sub_080739B0: @ 0x080739B0
	...
	ldrb r4, [r0]
_080739C8:
	ldr r0, _08073A20  @ =gUnknown_03000824
	add r1, r4, #1
	ldr r0, [r0]
	bl __modsi3
	cmp r0, r4
...
_080739DA:
	...
	strb r0, [r6]
_080739F4:
	ldr r0, _08073A28  @ =gUnknown_03001F28
	str r5, [r0]
	ldr r4, _08073A2C  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08073A30  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08073A06
	mov r3, #1
...
sub_08073A34: @ 0x08073A34
	...
	ldrb r1, [r0]
_08073A44:
	ldr r0, _08073A98  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, r1
	bne _08073A58
	mov r0, r12
...
_08073A58:
	...
	strb r0, [r5]
_08073A72:
	ldr r0, _08073AA0  @ =gUnknown_03001F28
	mov r1, r12
	str r1, [r0]
	ldr r4, _08073AA4  @ =gUnknown_03001EFC
	mov r3, #0
	ldr r0, _08073AA8  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08073A86
	mov r3, #1
...
sub_08073AAC: @ 0x08073AAC
	...
	ldrb r1, [r0]
_08073ABC:
	ldr r0, _08073B04  @ =gUnknown_03000824
	ldr r0, [r0]
	cmp r0, r1
	blt _08073AFE
	add r5, r3, #0
	...
	strb r0, [r5]
_08073ADE:
	ldr r0, _08073B0C  @ =gUnknown_03001F28
	str r3, [r0]
	ldr r4, _08073B10  @ =gUnknown_03001EFC
	mov r6, #0
	ldr r0, _08073B14  @ =gUnknown_03000820
	ldr r0, [r0]
	cmp r0, #0
	bne _08073AF0
	mov r6, #1
...
sub_08073B18: @ 0x08073B18
	...
	orr r0, r0, r1
	strh r0, [r2]
	ldr r4, _08073B7C  @ =gUnknown_03000840
	mov r3, #0
...
sub_08073B90: @ 0x08073B90
	...
	mov r6, r8
	push {r6,r7}
	ldr r0, _08073BE0  @ =gUnknown_03000840
	ldrb r1, [r0]
	add r5, r0, #0
	cmp r1, #2
	beq _08073BA4
...
_08073C0C:
	mov r1, r8
	add r0, r6, r1
	ldr r3, [r0, #4]  @ gUnknown_08B3A4AC[i].unk4
	ldrh r2, [r3]
	ldrh r1, [r0, #8]  @ gUnknown_08B3A4AC[i].unk8
	and r1, r1, r2
	ldr r0, [r4]
	asr r0, r0, #9
	orr r1, r1, r0
...
_08073C32:
	...
	add r0, r0, #40
	ldr r1, [r5, #60]
	add r3, r1, r0      @ gUnknown_03000840.unk3C + 40 + gUnknown_03000840.unk34*8
	ldrh r0, [r1, #38]
	lsl r0, r0, #3
	add r0, r0, #40
	add r4, r1, r0
...
_08073C54:
	...
	add r0, r0, r1
	lsl r0, r0, #2  @ * 12
	add r0, r0, r8  @ gUnknown_08B3A4AC + r3->unk2*12
	ldr r2, [r0, #4]  @ gUnknown_08B3A4AC[r3->unk2].unk4
	ldrh r1, [r2]
	ldr r1, [r0]    @ gUnknown_08B3A4AC[r3->unk12].unk0
	ldrh r0, [r3, #4]
	strh r0, [r1]
	ldrb r1, [r3, #2]
	lsl r0, r1, #1
	add r0, r0, r1
	lsl r0, r0, #2
	add r0, r0, r7  @ gUnknown_03000840 + 4 + r3->unk2*12
	ldr r0, [r0]	@ gUnknown_03000840.unk4[r3->unk2].unk0
	lsl r0, r0, #7
	lsr r0, r0, #16
	ldrh r1, [r3, #6]
	orr r0, r0, r1
...
_08073C86:
	...
	add r1, r1, r0
	lsl r1, r1, #2  @ * 12
	mov r0, r9      @ gUnknown_03000840
	add r0, r0, #12 @ gUnknown_03000840 + 0xC
	add r1, r1, r0
	ldrh r0, [r3, #4]
	lsl r0, r0, #21
	lsr r0, r0, #12
	...
	add r1, r1, r0
	lsl r1, r1, #2
	add r1, r1, r6  @ gUnknown_03000840 + 8 + r3->unk2*12
	ldr r0, [r3, #4]
	asr r0, r0, #11
	str r0, [r1]
_08073CB0:
...
sub_08073CE8: @ 0x08073CE8
	...
	add r5, r2, #0
	bl sub_08073E1C
	ldr r1, _08073D1C  @ =gUnknown_03000840
	mov r0, #0
	str r0, [r1, #52]
	ldrh r0, [r6, #40]
	str r0, [r1, #56]
...
_08073D20:
	...
	asr r4, r0, #6
_08073D2C:
	ldr r2, _08073DB4  @ =gUnknown_03000840
	lsl r0, r4, #4
	orr r0, r0, r1
	strh r0, [r2, #2]
...
_08073D48:
	...
	bge _08073D68
	lsl r0, r3, #1
	add r2, r0, r6   @ arg0->unk0 + r3*2
	sub r3, r4, r3   @ r3 = r4 - r3 = 8
_08073D58:
	ldrh r0, [r2]
	strh r0, [r1]
	add r1, r1, #2
...
_08073D68:
	...
	mov r1, #160
	strh r1, [r0]
	ldr r0, _08073DB4  @ =gUnknown_03000840
	mov r2, r12
	add r1, r0, #4
	mov r3, #2
_08073D7E:
...
sub_08073DC4: @ 0x08073DC4
	push {lr}
	ldr r1, _08073DE4  @ =gUnknown_03000840
	ldrb r0, [r1]
	cmp r0, #2
	bne _08073DE0
	ldrb r0, [r1]
...
sub_08073DEC: @ 0x08073DEC
	push {lr}
	ldr r3, _08073E14  @ =gUnknown_03000840
	ldrb r0, [r3]
	cmp r0, #1
	bne _08073E10
	ldrb r0, [r3]
...
sub_08073E1C: @ 0x08073E1C
	ldr r1, _08073E34  @ =gUnknown_03000840
	ldrb r0, [r1]
	mov r0, #0
	strb r0, [r1]
